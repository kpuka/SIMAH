...
server <- function(input, output, session) {
  ...
  output$poisson.cont_desc <- renderText((paste0("A total of ", calc_n(), " participants are required to achieve ", input$power*100, "% power to detect a clinically meaningful rate ratio of ", input$RR, ". This assumes a marginal mean of the outcome of ", input$mean," [units of outcome], the standard deviation of the independent variable of interest is ", input$sd_pred, ", the multiple correlation is ", input$corr, ", and the dispersion is ", input$dispr, ". Additionally, a false positive rate of ", input$alpha, ", and ", input$attrition*100, "% attrition were also assumed.")))
