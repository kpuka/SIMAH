  ...
  navbarPage(
      sidebarLayout(
        sidebarPanel(width = 5,
          ...
          parameter_reg,
          parameter_pred,
          numericInput("corr", "Multiple correlation", value=0, min=0, max=0.99, step=0.01) %>% tipify ("Leave as 0 if you do not plan to control for any other variables in your model. How strongly is your independent variable of interest correlated with the other variables you plan to adjust for in your analysis? To estimate this, consider conducting a regression where the outcome is the independent variable of interest and the predictors are the remaining variables to be controlled for - what is the R<sup>2</sup> of this regression? That should be what is entered in this field. Minimum: 0, Maximum: 0.99"),
